...
const fs = require("fs");
const catClick = require("./script.js");
...
describe("Script.js tests", () => {
    describe("catClick test", () => {
        test('catClick function modifies DOM correctly on click event', () => {
            ...
            // Assertions for picturesHTML
            expect(global.roomsPictures.innerHTML).toContain(`<img src="pic1.jpg">`);
            expect(global.roomsPictures.innerHTML).toContain(`<img src="pic2.jpg">`);
